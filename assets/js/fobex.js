...
$(window).scroll(function() {
  if ($(this).scrollTop() > 50) {
    $('.top1').addClass("fixed-top1");
    $('.background_white').addClass("bg_white");

    $('#headerId').removeClass("header-mobile-shadow");

      
  } else {
   
      $('.top1').removeClass("fixed-top1");
      $('.background_white').removeClass("bg_white");
      $('#headerId').addClass("header-mobile-shadow");
  }
});